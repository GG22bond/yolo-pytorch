...
from models.modules.common import Focus, Conv, C3, SPP, BottleneckCSP, C3TR
...
class YOLOv5(nn.Module):
    def __init__(self, focus=True, version='L', with_C3TR=False):
        ...
        self.out_shape = {'C3_size': self.channels_out['stage3_2'],  # 256
                          'C4_size': self.channels_out['stage4_2'],  # 512
                          'C5_size': self.channels_out['conv1']}     # 512
